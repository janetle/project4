      ...
      <div className = "tea-wrapper">
        ...
        <div className = "about">
          <div className = "just-tea">
            <img src = "/happy-people.jpg" width = "90px" height = "90px" />
          ...
          <div className = "just-tea">
            <img src = "/tree-grow.jpg" width = "90px" height = "90px" />
          ...
          <div className = "just-tea ">
            <img src = "/recyle.png" width = "90px" height = "90px" />
          ...
          <div className = "just-tea ">
            <img src = "/hot-tea.png" width = "90px" height = "90px" />
